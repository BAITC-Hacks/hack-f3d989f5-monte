...
> Данные и эффекты в кейсе синтетические. Результаты локальной проверки не описывают реальных абонентов Beeline и не гарантируют балл на скрытой модели судейства.
